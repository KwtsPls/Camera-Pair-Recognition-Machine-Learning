...
main: Queue.o  BinaryHeap.o Inference.o main.o JsonParser.o ErrorHandler.o Dictionary.o Bucket.o HashTable.o CsvReader.o BagOfWords.o  SecTable.o DataPreprocess.o LogisticRegression.o Metrics.o DataLoading.o Transitivity.o RBtree.o
	gcc -g3 main.o JsonParser.o ErrorHandler.o Dictionary.o  Bucket.o HashTable.o CsvReader.o BagOfWords.o  SecTable.o DataPreprocess.o LogisticRegression.o Metrics.o DataLoading.o  Transitivity.o Queue.o BinaryHeap.o RBtree.o  -o main -lm
	gcc -g3 Inference.o JsonParser.o ErrorHandler.o Dictionary.o Bucket.o HashTable.o CsvReader.o BagOfWords.o  SecTable.o DataPreprocess.o LogisticRegression.o Metrics.o DataLoading.o  Transitivity.o BinaryHeap.o Queue.o RBtree.o  -o inference -lm


#Make part for the test part of the program using acutest library
test: test_check.o test_machine_learning.o JsonParser.o ErrorHandler.o Dictionary.o Bucket.o HashTable.o CsvReader.o BagOfWords.o  SecTable.o DataPreprocess.o LogisticRegression.o Metrics.o DataLoading.o Transitivity.o BinaryHeap.o Queue.o RBtree.o
	gcc -g3 -lm test_check.o JsonParser.o ErrorHandler.o Dictionary.o Bucket.o HashTable.o BagOfWords.o  CsvReader.o SecTable.o DataPreprocess.o LogisticRegression.o Metrics.o DataLoading.o BinaryHeap.o Queue.o Transitivity.o RBtree.o   -o test -lm
	gcc -g3 -lm test_machine_learning.o JsonParser.o ErrorHandler.o Dictionary.o Bucket.o HashTable.o BagOfWords.o  CsvReader.o SecTable.o DataPreprocess.o LogisticRegression.o Metrics.o DataLoading.o  BinaryHeap.o Queue.o Transitivity.o RBtree.o   -o learning_test -lm
...
clean:
	rm main test main.o JsonParser.o ErrorHandler.o CsvReader.o Bucket.o HashTable.o Dictionary.o test_check.o SecTable.o DataPreprocess.o BagOfWords.o cliques.csv LogisticRegression.o Metrics.o test_machine_learning.o Inference.o DataLoading.o Transitivity.o RBtree.o   neg_cliques.csv predictions.csv inference learning_test